...
extern "C" {
    #[doc = " Saves the bitmap as a PNG file."]
    #[link_name = "\u{1}_ZN7msdfgen7savePngERKNS_14BitmapConstRefIhLi1EEEPKc"]
    pub fn msdfgen_savePng(
        bitmap: *const msdfgen_BitmapConstRef<msdfgen_byte>,
        filename: *const ::std::os::raw::c_char,
    ) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_ZN7msdfgen7savePngERKNS_14BitmapConstRefIhLi3EEEPKc"]
    pub fn msdfgen_savePng1(
        bitmap: *const msdfgen_BitmapConstRef<msdfgen_byte>,
        filename: *const ::std::os::raw::c_char,
    ) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_ZN7msdfgen7savePngERKNS_14BitmapConstRefIhLi4EEEPKc"]
    pub fn msdfgen_savePng2(
        bitmap: *const msdfgen_BitmapConstRef<msdfgen_byte>,
        filename: *const ::std::os::raw::c_char,
    ) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_ZN7msdfgen7savePngERKNS_14BitmapConstRefIfLi1EEEPKc"]
    pub fn msdfgen_savePng3(
        bitmap: *const msdfgen_BitmapConstRef<f32>,
        filename: *const ::std::os::raw::c_char,
    ) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_ZN7msdfgen7savePngERKNS_14BitmapConstRefIfLi3EEEPKc"]
    pub fn msdfgen_savePng4(
        bitmap: *const msdfgen_BitmapConstRef<f32>,
        filename: *const ::std::os::raw::c_char,
    ) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_ZN7msdfgen7savePngERKNS_14BitmapConstRefIfLi4EEEPKc"]
    pub fn msdfgen_savePng5(
        bitmap: *const msdfgen_BitmapConstRef<f32>,
        filename: *const ::std::os::raw::c_char,
    ) -> bool;
}
extern "C" {
    #[doc = " Builds a shape from an SVG path string"]
    #[link_name = "\u{1}_ZN7msdfgen21buildShapeFromSvgPathERNS_5ShapeEPKcd"]
    pub fn msdfgen_buildShapeFromSvgPath(
        shape: *mut msdfgen_Shape,
        pathDef: *const ::std::os::raw::c_char,
        endpointSnapRange: f64,
    ) -> bool;
}
extern "C" {
    #[doc = " Reads the first path found in the specified SVG file and stores it as a Shape in output."]
    #[link_name = "\u{1}_ZN7msdfgen12loadSvgShapeERNS_5ShapeEPKciPNS_7Vector2E"]
    pub fn msdfgen_loadSvgShape(
        output: *mut msdfgen_Shape,
        filename: *const ::std::os::raw::c_char,
        pathIndex: ::std::os::raw::c_int,
        dimensions: *mut msdfgen_Vector2,
    ) -> bool;
}
pub type msdfgen_unicode_t = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct msdfgen_FreetypeHandle {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct msdfgen_FontHandle {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct msdfgen_GlyphIndex {
    pub index: ::std::os::raw::c_uint,
}
#[test]
fn bindgen_test_layout_msdfgen_GlyphIndex() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_GlyphIndex> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<msdfgen_GlyphIndex>(),
        4usize,
        concat!("Size of: ", stringify!(msdfgen_GlyphIndex))
    );
    assert_eq!(
        ::std::mem::align_of::<msdfgen_GlyphIndex>(),
        4usize,
        concat!("Alignment of ", stringify!(msdfgen_GlyphIndex))
    );
    assert_eq!(
...
extern "C" {
    #[link_name = "\u{1}_ZNK7msdfgen10GlyphIndex8getIndexEv"]
    pub fn msdfgen_GlyphIndex_getIndex(this: *const msdfgen_GlyphIndex) -> ::std::os::raw::c_uint;
}
extern "C" {
    #[link_name = "\u{1}_ZN7msdfgen10GlyphIndexC1Ej"]
    pub fn msdfgen_GlyphIndex_GlyphIndex(
        this: *mut msdfgen_GlyphIndex,
        index: ::std::os::raw::c_uint,
    );
}
impl msdfgen_GlyphIndex {
    #[inline]
    pub unsafe fn getIndex(&self) -> ::std::os::raw::c_uint {
        msdfgen_GlyphIndex_getIndex(self)
    }
    #[inline]
    pub unsafe fn new(index: ::std::os::raw::c_uint) -> Self {
        let mut __bindgen_tmp = ::std::mem::MaybeUninit::uninit();
        msdfgen_GlyphIndex_GlyphIndex(__bindgen_tmp.as_mut_ptr(), index);
        __bindgen_tmp.assume_init()
    }
}
#[doc = " Global metrics of a typeface (in font units)."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct msdfgen_FontMetrics {
    #[doc = " The size of one EM."]
    pub emSize: f64,
    #[doc = " The vertical position of the ascender and descender relative to the baseline."]
    pub ascenderY: f64,
    #[doc = " The vertical position of the ascender and descender relative to the baseline."]
    pub descenderY: f64,
    #[doc = " The vertical difference between consecutive baselines."]
    pub lineHeight: f64,
    #[doc = " The vertical position and thickness of the underline."]
    pub underlineY: f64,
    #[doc = " The vertical position and thickness of the underline."]
    pub underlineThickness: f64,
}
#[test]
fn bindgen_test_layout_msdfgen_FontMetrics() {
    const UNINIT: ::std::mem::MaybeUninit<msdfgen_FontMetrics> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<msdfgen_FontMetrics>(),
        48usize,
        concat!("Size of: ", stringify!(msdfgen_FontMetrics))
    );
    assert_eq!(
        ::std::mem::align_of::<msdfgen_FontMetrics>(),
        8usize,
        concat!("Alignment of ", stringify!(msdfgen_FontMetrics))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).emSize) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(msdfgen_FontMetrics),
            "::",
            stringify!(emSize)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ascenderY) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(msdfgen_FontMetrics),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).descenderY) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(msdfgen_FontMetrics),
            "::",
            stringify!(descenderY)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).underlineY) as usize - ptr as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(msdfgen_FontMetrics),
            "::",
            stringify!(underlineY)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).underlineThickness) as usize - ptr as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(msdfgen_FontMetrics),
            "::",
            stringify!(underlineThickness)
        )
    );
}
extern "C" {
    #[doc = " Initializes the FreeType library."]
    #[link_name = "\u{1}_ZN7msdfgen18initializeFreetypeEv"]
    pub fn msdfgen_initializeFreetype() -> *mut msdfgen_FreetypeHandle;
}
extern "C" {
    #[doc = " Deinitializes the FreeType library."]
    #[link_name = "\u{1}_ZN7msdfgen20deinitializeFreetypeEPNS_14FreetypeHandleE"]
    pub fn msdfgen_deinitializeFreetype(library: *mut msdfgen_FreetypeHandle);
}
extern "C" {
    #[doc = " Loads a font file and returns its handle."]
    #[link_name = "\u{1}_ZN7msdfgen8loadFontEPNS_14FreetypeHandleEPKc"]
    pub fn msdfgen_loadFont(
        library: *mut msdfgen_FreetypeHandle,
        filename: *const ::std::os::raw::c_char,
    ) -> *mut msdfgen_FontHandle;
}
extern "C" {
    #[doc = " Loads a font from binary data and returns its handle."]
    #[link_name = "\u{1}_ZN7msdfgen12loadFontDataEPNS_14FreetypeHandleEPKhi"]
    pub fn msdfgen_loadFontData(
        library: *mut msdfgen_FreetypeHandle,
        data: *const msdfgen_byte,
        length: ::std::os::raw::c_int,
    ) -> *mut msdfgen_FontHandle;
}
extern "C" {
    #[doc = " Unloads a font file."]
    #[link_name = "\u{1}_ZN7msdfgen11destroyFontEPNS_10FontHandleE"]
    pub fn msdfgen_destroyFont(font: *mut msdfgen_FontHandle);
}
extern "C" {
    #[doc = " Outputs the metrics of a font file."]
    #[link_name = "\u{1}_ZN7msdfgen14getFontMetricsERNS_11FontMetricsEPNS_10FontHandleE"]
    pub fn msdfgen_getFontMetrics(
        metrics: *mut msdfgen_FontMetrics,
        font: *mut msdfgen_FontHandle,
    ) -> bool;
}
extern "C" {
    #[doc = " Outputs the width of the space and tab characters."]
    #[link_name = "\u{1}_ZN7msdfgen22getFontWhitespaceWidthERdS0_PNS_10FontHandleE"]
    pub fn msdfgen_getFontWhitespaceWidth(
        spaceAdvance: *mut f64,
        tabAdvance: *mut f64,
        font: *mut msdfgen_FontHandle,
    ) -> bool;
}
extern "C" {
    #[doc = " Outputs the glyph index corresponding to the specified Unicode character."]
    #[link_name = "\u{1}_ZN7msdfgen13getGlyphIndexERNS_10GlyphIndexEPNS_10FontHandleEj"]
    pub fn msdfgen_getGlyphIndex(
        glyphIndex: *mut msdfgen_GlyphIndex,
        font: *mut msdfgen_FontHandle,
        unicode: msdfgen_unicode_t,
    ) -> bool;
}
extern "C" {
    #[doc = " Loads the geometry of a glyph from a font file."]
    #[link_name = "\u{1}_ZN7msdfgen9loadGlyphERNS_5ShapeEPNS_10FontHandleENS_10GlyphIndexEPd"]
    pub fn msdfgen_loadGlyph(
        output: *mut msdfgen_Shape,
        font: *mut msdfgen_FontHandle,
        glyphIndex: msdfgen_GlyphIndex,
        advance: *mut f64,
    ) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_ZN7msdfgen9loadGlyphERNS_5ShapeEPNS_10FontHandleEjPd"]
    pub fn msdfgen_loadGlyph1(
        output: *mut msdfgen_Shape,
        font: *mut msdfgen_FontHandle,
        unicode: msdfgen_unicode_t,
        advance: *mut f64,
...
extern "C" {
    #[doc = " Outputs the kerning distance adjustment between two specific glyphs."]
    #[link_name = "\u{1}_ZN7msdfgen10getKerningERdPNS_10FontHandleENS_10GlyphIndexES3_"]
    pub fn msdfgen_getKerning(
        output: *mut f64,
        font: *mut msdfgen_FontHandle,
        glyphIndex1: msdfgen_GlyphIndex,
        glyphIndex2: msdfgen_GlyphIndex,
    ) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_ZN7msdfgen10getKerningERdPNS_10FontHandleEjj"]
    pub fn msdfgen_getKerning1(
        output: *mut f64,
        font: *mut msdfgen_FontHandle,
        unicode1: msdfgen_unicode_t,
        unicode2: msdfgen_unicode_t,
    ) -> bool;
}
...
pub type msdf_atlas_byte = ::std::os::raw::c_uchar;
